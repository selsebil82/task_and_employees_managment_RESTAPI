...
@media (max-width: 420px) {
    ...
    <ul class="nav-list">
      <li>
        <a href="#" id="task-link">
          ...
          <span class="links_name">Task Management</span>
        </a>
        <span class="tooltip">Task Management</span>
      </li>
      <li>
        <a href="#" id="employee-link">
  ...
  <script>
    ...
    let taskLink = document.querySelector("#task-link");
    let employeeLink = document.querySelector("#employee-link");
